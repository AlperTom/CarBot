...
// Email configuration
const EMAIL_CONFIG = {
  from: `${process.env.EMAIL_FROM_NAME || 'CarBot'} <${process.env.EMAIL_FROM || 'noreply@carbot.de'}>`,
  replyTo: process.env.WORKSHOP_EMAIL || 'support@carbot.de'
}
    ...
    <body style="font-family: 'Segoe UI', Tahoma, Geneva, Verdana, sans-serif; line-height: 1.6; color: #333; max-width: 600px; margin: 0 auto; background-color: #f8fafc;">
      ...
      <div style="background: white; padding: 30px 20px; border-radius: 0 0 12px 12px; box-shadow: 0 4px 6px rgba(0, 0, 0, 0.1);">
        ...
        <ul style="list-style: none; padding: 0;">
          <li>📧 E-Mail: <a href="mailto:support@carbot.de" style="color: #0070f3;">support@carbot.de</a></li>
        ...
        <p style="color: #6b7280; font-size: 14px; margin-bottom: 0;">
          Ihr CarBot-Team<br>
          <a href="https://carbot.de" style="color: #0070f3;">carbot.de</a>
        </p>
      </div>
